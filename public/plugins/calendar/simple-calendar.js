      ...
      if (this._options.theme.changeAble) {
        ...
        days.forEach(function (v, i) {
          v.onmouseover = function (e) {
            if(this.className.indexOf("sc-today") == -1) {
                this.style.borderColor = theme.activeSelectColor;
                this.style.borderWidth = '0.1px';
                this.style.borderRadius = '50%';
                this.style.backgroundColor = theme.activeSelectColor;
                this.getElementsByClassName("day")[0].style.color = '#FFFFFF';
            }
        };
          v.onmouseout = function (e) {
              if(this.className.indexOf("sc-today") == -1) {
                  ...
                  this.getElementsByClassName("day")[0].style.color = '#565555'
              }
              if(this.className.indexOf("sc-selected") != -1) {
                  this.style.borderRadius = '50%';
                  this.style.borderWidth = '1px';
              }
              if(this.className.indexOf("sc-mark") != -1) {
                  this.style.borderRadius = '50%';
